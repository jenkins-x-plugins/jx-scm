...
import (
	...
	"github.com/jenkins-x-plugins/jx-scm/pkg/cmd/pr/create"
)

func TestCreatePullRequest(t *testing.T) {
	_, o := create.NewCmdCreatePullRequest()
	...
	createPR(t, o, fullName, scmClient)
	createPRAgainWithoutAllowUpdate(t, o, fullName, scmClient)
	createPRAgainWithAllowUpdate(t, o, fullName, scmClient)
}

func createPR(t *testing.T, o *create.Options, fullName string, scmClient *scm.Client) {
	...
	prs := assertExpectedPRFound(t, o, fullName, scmClient)

	assert.Equal(t, prs[0].Title, o.Title, "title not properly set")
	assert.Equal(t, prs[0].Body, o.Body, "body not properly set")
}

func createPRAgainWithoutAllowUpdate(t *testing.T, o *create.Options, fullName string, scmClient *scm.Client) {
...
func createPRAgainWithAllowUpdate(t *testing.T, o *create.Options, fullName string, scmClient *scm.Client) {
...
func assertExpectedPRFound(t *testing.T, o *create.Options, fullName string, scmClient *scm.Client) []*scm.PullRequest {
